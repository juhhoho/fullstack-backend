package _2025.fullstack.backend.domain.progress.service;

import _2025.fullstack.backend.common.apiPayload.failure.customException.LandmarkException;
import _2025.fullstack.backend.common.apiPayload.failure.customException.UserException;
import _2025.fullstack.backend.domain.landmark.repository.LandmarkRepository;
...
import _2025.fullstack.backend.domain.progress.repository.ProgressRepository;
import _2025.fullstack.backend.domain.user.entity.User;
import _2025.fullstack.backend.domain.user.jwt.JWTUtil;
import _2025.fullstack.backend.domain.user.repository.UserRepository;
import _2025.fullstack.backend.external.ai.AiService;
